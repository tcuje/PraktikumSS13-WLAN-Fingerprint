...
public class CustomTabHelper implements OnClickListener {
	...
	public static CustomTabHelper createInstance(ArrayList<View> headerList,
			ArrayList<ViewGroup> contentList) {
	...
	public void selectTabByPosition(int pos) {
		for (int i = 0; i < size; i++) {
			if (i == pos) {
				contentList.get(i).setVisibility(View.VISIBLE);
			} else {
