...
public class FloorSpinnerHelper implements
	OnItemSelectedListener, OnBuildingChangedListener {
	...
	private FloorSpinnerHelper(Context context, StorageHandler storage, List<Spinner> spinner) {
	...
	public static FloorSpinnerHelper createInstance(Context context, OnFloorChangedListener listener, StorageHandler storage, Spinner spinner) {
		ArrayList<Spinner> spinnerList = new ArrayList<Spinner>();
		spinnerList.add(spinner);
		
		FloorSpinnerHelper helper = new FloorSpinnerHelper(context, storage, spinnerList);
		helper.addListener(listener);
		return helper;
	}
	
	public static FloorSpinnerHelper createInstance(Context context, OnFloorChangedListener listener, StorageHandler storage, List<Spinner> spinnerList) {
		FloorSpinnerHelper helper = new FloorSpinnerHelper(context, storage, spinnerList);
		helper.addListener(listener);
		return helper;
	}
